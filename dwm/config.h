...
// static const char *fonts[]          = { "JetBrains Mono NerdFont:size=8" };
static const char *fonts[]          = { "JetBrainsMono NF SemiBold:size=12" };
static const char dmenufont[]       = "JetBrains Mono NerdFont:size=14";
// top bar item when not delected
static const char norm_fg[] = "#abe9b3";
static const char norm_bg[] = "#025f39";
static const char norm_border[] = "#000000";

static const char sel_fg[] = "#ebdbb2";
static const char sel_bg[] = "#0f1f1e";
static const char sel_border[] = "#4ab379";

static const char urg_fg[] = "#d3dccf";
static const char urg_bg[] = "#12461f";
...
static const char *tags[] = { "", "", "󰮤", "doc", "vbox", "chat", "mus", "vid", "gfx" };
...
static const Key keys[] = {
	...
	{ 0,				XF86XK_AudioPlay,	           spawn,         SHCMD("notify-send something") },
};
